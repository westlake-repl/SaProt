...
## News
- 2023/10/30: We release the pre-trained [SaProt 35M model](https://huggingface.co/westlake-repl/SaProt_35M_AF2) and a [35M residue sequence-only version of SaProt](https://huggingface.co/westlake-repl/SaProt_35M_AF2_seqOnly) (for comparison)! The sequence-only SaProt performs competitively with ESM-2 35M model. 
